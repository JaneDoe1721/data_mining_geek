...
class Parser5ka:
    ...
    def save_to_json_file(data: dict, file_name):
        with open(f'products/{file_name}.json', 'w', encoding='UTF-8') as file_js:
            json.dump(data, file_js, ensure_ascii=False)


class Cat5ka(Parser5ka):
...
if __name__ == '__main__':
    parser = Cat5ka('https://5ka.ru/api/v2/special_offers/', 'https://5ka.ru/api/v2/categories/')
    parser.run()